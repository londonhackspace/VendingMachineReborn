...
set(CMAKE_C_FLAGS "-g -Os -std=gnu11 -ffunction-sections -fdata-sections --param max-inline-insns-single=500 -Dprintf=iprintf -MMD -DF_CPU=120000000L -DARDUINO=100 -mcpu=cortex-m4 -mthumb -mfloat-abi=hard -mfpu=fpv4-sp-d16 -fsingle-precision-constant -specs=nano.specs" CACHE STRING "")
set(CMAKE_CXX_FLAGS "-g -Os -std=gnu++11 -ffunction-sections -fdata-sections -fno-threadsafe-statics --param max-inline-insns-single=500 -fno-rtti -fno-exceptions -Dprintf=iprintf -MMD -DF_CPU=120000000L -DARDUINO=100 -mcpu=cortex-m4 -mthumb -mfloat-abi=hard -mfpu=fpv4-sp-d16 -fsingle-precision-constant -specs=nano.specs"  CACHE STRING "")
